...
[AddComponentMenu("uScript/Graphs/ShopArea")]
public class ShopArea_Component : uScriptCode
{
   #pragma warning disable 414
   public ShopArea ExposedVariables = new ShopArea( ); 
      ...
      {
         {
            ...
            gameObject = GameObject.Find( "AI_Enemy" ); 
            if ( null != gameObject ) Gizmos.DrawIcon(gameObject.transform.position, "uscript_gizmo_variables.png");
         }
         {
            GameObject gameObject;
            gameObject = GameObject.Find( "T_Move" ); 
            if ( null != gameObject ) Gizmos.DrawIcon(gameObject.transform.position, "uscript_gizmo_variables.png");
         }
         {
            GameObject gameObject;
            gameObject = GameObject.Find( "RigidBodyFPSController" ); 
            if ( null != gameObject ) Gizmos.DrawIcon(gameObject.transform.position, "uscript_gizmo_variables.png");
         }
      }
   #endif
